    ...
    playPage.prototype.createChildren = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                bg.graphics.endFill();
                this.addChild(bg);
                bgm = RES.getRes("bgm_mp3");
                bgmText = new egret.TextField();
                btn = new soundCtrlBtn("btn_on_png", "btn_off_png", function () { SoundControl.play("kick", 1, 0); }, function () { SoundControl.stop(); });
                this.addChild(btn);
                btn.x = 400;
                btn.y = 200;
                return [2 /*return*/];
